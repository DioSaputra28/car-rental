    ...
    @section('meta_title', 'Daftar Mobil - ' . get_site_name() . ' | Sewa Mobil Premium Jakarta')
    @section('meta_description', 'Lihat koleksi lengkap armada mobil premium kami. Alphard, Fortuner, Innova, dan berbagai pilihan mobil mewah lainnya. Harga kompetitif, kondisi prima, siap melayani kebutuhan perjalanan Anda.')
    @section('meta_keywords', 'daftar mobil, armada mobil, sewa alphard, rental fortuner, sewa innova, mobil premium jakarta')

    @section('og_title', 'Armada Mobil Premium - ' . get_site_name())
    @section('og_description', 'Pilih dari berbagai armada mobil premium kami. Kondisi terbaik, harga terjangkau, booking mudah.')
    @section('og_image', asset('assets/img/banner.png'))
